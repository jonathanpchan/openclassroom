...
var BuildingsService = (function () {
    ...
    BuildingsService.prototype.getBuildings = function (name) {
        ...
        return this.http.post('buildings', { name: name }).map(function (res) { return res.json(); }).catch(this.handleError);
    };
    BuildingsService.prototype.getAll = function () {
        ...
        return this.http.get('buildings', null).map(function (res) { return res.json(); }).catch(this.handleError);
    };
    BuildingsService.prototype.getBuildingNames = function () {
        ...
        return this.http.get('buildings/names', null).map(function (res) { return res.json(); }).catch(this.handleError);
    };
